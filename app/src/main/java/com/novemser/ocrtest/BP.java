...
public class BP implements Serializable {
    ...
    public double[][] getHidOptPrevUptWeights() {
        return hidOptPrevUptWeights;
    }

    public double[][] getHidOptWeights() {
        return hidOptWeights;
    }

    public double[][] getIptHidPrevUptWeights() {
        return iptHidPrevUptWeights;
    }

    public double[][] getIptHidWeights() {
        return iptHidWeights;
    }

    public double[] getOptDelta() {
        return optDelta;
    }

    public double[] getHidDelta() {
        return hidDelta;
    }
    ...
    public BP(int inputSize, int hiddenSize, int outputSize) {
        this(inputSize, hiddenSize, outputSize, 0.05, 0.1);
        trainLable = new int[] {
           9, 2, 4, 1, 2, 6, 8, 1, 0, 5, 3, 4, 0, 1, 7, 7, 5, 6, 3, 8, 2, 9
        };
    }
